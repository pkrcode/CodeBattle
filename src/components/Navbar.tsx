      ...
      <div className="md:hidden">
        <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <Link
                ...
                className={`flex items-center space-x-2 px-3 py-2 rounded-md text-base font-medium transition-all duration-200 ${
                  isActive
                    ...
                    : `${
                        theme === 'dark' 
                          ? 'text-gray-300 hover:bg-white hover:text-slate-900' 
          ...
          <button
            ...
            className="flex items-center space-x-2 px-3 py-2 rounded-md text-base font-medium w-full text-left text-red-600 hover:bg-red-50 transition-all duration-200"
          >
